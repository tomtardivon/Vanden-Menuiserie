...
export const metadata: Metadata = {
  ...
  description: "Vanden Menuiserie, votre menuisier professionnel à Toulon. Cuisines sur mesure, escaliers, fenêtres. 38 ans d'expérience dans le Var. Devis gratuit ☎ 07 62 14 43 40",
  keywords: [
    "menuisier toulon",
