...
export function HyeresPageContent() {
  return (
    <main className="relative pt-18">
      ...
      <section className="relative min-h-screen flex items-center bg-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{
              backgroundImage: `url('/villes/hyeres/hyères.jpg')`,
            }}
          />
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-white">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">📍 Hyères, Var (83400)</span>
            </motion.div>
            ...
            >
              Menuisier
              <span className="block text-brun-bois">à Hyères</span>
            </motion.h1>
            ...
            >
              {[
                ...
                { number: "200+", label: "Villas à Hyères" },
                { number: "100%", label: "Haut de gamme" }
              ].map((stat, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-bleu-marine/70 max-w-3xl mx-auto">
              Découvrez quelques-unes de nos plus belles créations hyéroises
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              projects.find(p => p.id === 'parquet-massif-65m2'),
              projects.find(p => p.id === 'dressing-luxe-5'),
              projects.find(p => p.id === 'meuble-cave-vins-integre')
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Mobilier sur mesure et agencements",
      ...
      {/* Schema LocalBusiness pour Hyères */}
      <script
