...
export function FrejusPageContent() {
  return (
    <main className="relative pt-18">
      ...
      <section className="relative min-h-screen flex items-center bg-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{
              backgroundImage: `url('/villes/frejus/frejus.jpg')`,
            }}
          />
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-white">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium">📍 Fréjus, Var (83600)</span>
            </motion.div>
            ...
            >
              Menuisier
              <span className="block text-brun-bois">à Fréjus</span>
            </motion.h1>
            ...
            >
              <span className="text-brun-bois font-semibold">38 ans d'expertise</span> au cœur de Fréjus.
              Concepteur d'espaces sur mesure, aménagements extérieurs et créations d'exception.
            </motion.p>
            ...
            >
              {[
                ...
                { number: "150+", label: "Projets à Fréjus" },
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-bleu-marine/70 max-w-3xl mx-auto">
              Découvrez quelques-unes de nos plus belles créations fréjusiennes
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              projects.find(p => p.id === 'cuisine-moderne-1'),
              projects.find(p => p.id === 'dressing-moderne-3'),
              projects.find(p => p.id === 'porte-style-verriere')
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                city: "Toulon",
                description: "Cuisines sur mesure et menuiseries d'exception",
      ...
      {/* Schema LocalBusiness pour Fréjus */}
      <script
