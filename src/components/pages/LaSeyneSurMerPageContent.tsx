...
export function LaSeyneSurMerPageContent() {
  return (
        ...
        <section className="relative min-h-screen flex items-center bg-white overflow-hidden">
          ...
          <div className="absolute inset-0">
            <div 
              ...
              style={{
                backgroundImage: `url('/villes/la-seyne-sur-mer/la-seyne-sur-mer.jpg')`,
              }}
            />
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10 text-white">
            ...
            >
              ...
              >
                ...
                <span className="text-sm font-medium">📍 La Seyne-sur-Mer, Var (83500)</span>
              </motion.div>
              ...
              >
                Menuisier
                <span className="block text-brun-bois">à La Seyne</span>
              </motion.h1>
              ...
              >
                {[
                  ...
                  { number: "120+", label: "Projets à La Seyne" },
                  { number: "100%", label: "Artisanal" }
                ].map((stat, index) => (
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-bleu-marine/70 max-w-3xl mx-auto">
                Découvrez quelques-unes de nos plus belles créations seynoises
              </p>
            </motion.div>
